...
//  specialVersion = " (version for XXXX)";
  ...
  CLog::Log(LOGNOTICE, "%s compiled by %s for %s %s %d-bit %s (%s)", CSysInfo::GetAppName().c_str(), g_sysinfo.GetUsedCompilerNameAndVer().c_str(), g_sysinfo.GetBuildTargetPlatformName().c_str(),
